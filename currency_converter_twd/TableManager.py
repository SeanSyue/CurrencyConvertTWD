...
class TableManager:
    ...
    def __init__(self):
        self.__sys_mgr = self.__FileSystemManager(Path(__file__).parent)
        self.__res_mgr = self.__OnlineResourceManager()
